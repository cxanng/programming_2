...
int main() {
    ...
    while ( true ) {
        ...
        command_to_be_executed = uppered(command_to_be_executed);
        bool check = false;
                ...
                if (pieces.size() != command.parameter_number +1) {
                    ...
                    if (command.exit) {
                        ...
                        return EXIT_SUCCESS;
                            ...
                            double num1, num2;
                            if (!string_to_double(pieces.at(1),num1) || !string_to_double(pieces.at(2),num2)) {
                                cout << "Error: a non-number operand." << endl;
                                continue;
                            }
                            else {
                                cout << command.action(num1,num2) << endl;
                            }
                        }
                    }
            }
